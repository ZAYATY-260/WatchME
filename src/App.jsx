            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-row md:flex-row gap-4 mt-4">
                <div className="flex flex-wrap gap-4 mt-6">
                  <button
                    key={heroMovie.id + "-play"}
                    className="flex items-center gap-2 bg-white text-black hover:bg-gray-200 px-6 py-2 rounded-md font-semibold text-sm sm:text-base transition-all duration-200 shadow-md"
                  ...
                  <button
                    key={heroMovie.id + "-info"}
                    className="flex items-center gap-2 bg-white/20 text-white hover:bg-white/30 px-6 py-2 rounded-md font-semibold text-sm sm:text-base transition-all duration-200 backdrop-blur-sm border border-white/30 shadow-md"
                    onClick={() => navigate(`/movie/${heroMovie.id}`)}
                  >
...
function MovieSection({ title, movies, navigate, favorites, toggleFavorite }) {
      ...
      >
        {movies.map((movie) => {
          ...
          return (
            <div
              key={movie.id}
              className="snap-start flex-shrink-0 w-[140px] sm:w-[180px] md:w-[220px] rounded-xl shadow-lg overflow-hidden cursor-pointer transform transition duration-100 hover:scale-105 hover:shadow-2xl hover:-translate-y-1 bg-gradient-to-tr from-gray-900/80 to-gray-800/70 relative"
